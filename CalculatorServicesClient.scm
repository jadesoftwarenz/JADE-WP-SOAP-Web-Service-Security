...
typeHeaders
	...
	RaiseSecurityTokenException subclassOf Object transient, transientAllowed, subclassTransientAllowed, webService, wsdlName = "raiseSecurityTokenException	urn:JadeWebServices/CalculatorService/";
	RaiseSecurityTokenExceptionResponse subclassOf Object transient, transientAllowed, subclassTransientAllowed, webService, wsdlName = "raiseSecurityTokenExceptionResponse	urn:JadeWebServices/CalculatorService/";
...
`;
	...
	webServicesMethodDefinitions
		add(inputParameters: Add): AddResponse updating, webService, wsdlName = "add";
		...
		divide(inputParameters: Divide): DivideResponse updating, webService, wsdlName = "divide";
		webServicesMethodProperties
		(
			inputEncodingStyle = "";
			inputNamespace = "";
		...
		multiply(inputParameters: Multiply): MultiplyResponse updating, webService, wsdlName = "multiply";
		webServicesMethodProperties
		(
			inputEncodingStyle = "";
			inputNamespace = "";
		...
		raiseSecurityTokenException(inputParameters: RaiseSecurityTokenException): RaiseSecurityTokenExceptionResponse updating, webService, wsdlName = "raiseSecurityTokenException";
		webServicesMethodProperties
		(
			inputEncodingStyle = "";
			inputNamespace = "";
		...
		subtract(inputParameters: Subtract): SubtractResponse updating, webService, wsdlName = "subtract";
		webServicesMethodProperties
		(
			inputEncodingStyle = "";
			inputNamespace = "";
...
`
    This class was generated by Jade.
     ...
     the class is regenerated. `
	attributeDefinitions
		msg:                           String required, webService, wsdlName = "urn:JadeWebServices/CalculatorService/:msg", _xmlType = "string	http://www.w3.org/2001/XMLSchema";
	)
...
`
    This class was generated by Jade.
     ...
     the class is regenerated. `
	attributeDefinitions
		raiseSecurityTokenExceptionResult:String required, webService, wsdlName = "urn:JadeWebServices/CalculatorService/:raiseSecurityTokenExceptionResult", _xmlType = "anyType	http://www.w3.org/2001/XMLSchema";
	)
